          ...
          <div id="contact">
            ...
            <p className="text-muted-foreground ">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-gray-400 transition-colors"
              >
                LinkedIn
              </a>{" "}
              or send an email to{" "}
              <span className="text-blue-600 hover:text-gray-400 transition-colors">
                {" "}
                amandee.manushika.e@gmail.com
              </span>{" "}
